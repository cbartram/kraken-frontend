...
import {CalendarDays, Package, AlertCircle, Key, AlarmClockOff} from 'lucide-react';
...
// On Plugins page the test is hard to read with bg's like cerberus and olm. Make sure it is easy to read
const Profile = () => {
